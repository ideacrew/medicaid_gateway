...
StimulusReflex.configure do |config|
  ...
  # Available tokens: session_id, session_id_full, reflex_info, operation, reflex_id, reflex_id_full,
  # mode, selector, operation_counter, connection_id, connection_id_full, timestamp
  ...
  if ENV["MG_DEBUG"] # enables logging in prod-like lower envs
    config.logging = proc {
