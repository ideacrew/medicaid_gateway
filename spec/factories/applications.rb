...
FactoryBot.define do
  factory :application, class: "::Medicaid::Application" do
    ...
    application_request_payload { "{\"us_state\":\"ME\",\"hbx_id\":\"200000123\"}" }
    application_response_payload { "{\"us_state\":\"ME\",\"hbx_id\":\"200000123\"}" }
    medicaid_request_payload { "{\"Applicants\":[{\"Person ID\":95}]}" }
    dynamic_slcsp_request_payload { "{\"us_state\":\"ME\",\"hbx_id\":\"200000123\"}" }
    dynamic_slcsp_response_payload { "{\"us_state\":\"ME\",\"hbx_id\":\"200000123\"}" }
