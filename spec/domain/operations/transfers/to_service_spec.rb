...
describe Transfers::ToService, "given an ATP valid payload, transfer it to the specified service" do
  ...
  context 'success' do
    ...
    context 'with valid application transfer to Curam with response not as 200' do
    ...
    context 'with valid application transfer to aces with response not as 200' do
      let(:failure_response) do
        {
          :status => 504,
          :body => response_body,
