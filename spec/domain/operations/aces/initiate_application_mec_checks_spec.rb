...
describe Aces::InitiateApplicationMecChecks, dbclean: :after_each do
  before :all do
  ...
  context 'request for Aces' do
    ...
    # subject.call(payload: payload, :message_id => "1234")
    # end
    ...
    context '#get_applicant_checks' do
      ...
      it ' should return a success' do
        result = subject.call(payload: payload, :message_id => "1234")
