...
RSpec.shared_context "cms ME simple_scenarios test_case_c_eligibility_override", :shared_context => :metadata do
  ...
  let(:aisha) do
    { name: { first_name: "Aisha", last_name: "Curtis" },
      ...
      citizenship_immigration_status_information: { citizen_status: "not_lawfully_present_in_us", is_lawful_presence_self_attested: false },
    ...
    { :"Determination Date" => Date.today.to_s,
      :Applicants => [
        { :"Person ID" => 95,
          ...
          :Determinations => { :Residency => { :Indicator => "Y" },
