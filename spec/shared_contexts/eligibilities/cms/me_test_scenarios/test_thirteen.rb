...
RSpec.shared_context 'cms ME me_test_scenarios test_thirteen', :shared_context => :metadata do
  ...
  let(:app_params) do
    {
      "family_reference" => {
        ...
        "name" => {
          "first_name" => "Rich", "middle_name" => nil, "last_name" => "Test", "name_sfx" => nil, "name_pfx" => nil
        },
        "identifying_information" => {
          "encrypted_ssn" => "5O82Dm9nfz7cpl/CwC3PJoEDvf4DI8FNlQ==\n", "has_ssn" => false
        },
        "demographic" => {
          "gender" => "Male", "dob" => "1964-04-22", "ethnicity" => ["", "", "", "", "", "", ""], "race" => nil, "is_veteran_or_active_military" => false, "is_vets_spouse_or_child" => false
        },
        "attestation" => {
        ...
        "family_member_reference" => {
          "family_member_hbx_id" => "1062521", "first_name" => "Rich", "last_name" => "Test", "person_hbx_id" => "1062521", "is_primary_family_member" => true
        },
        "person_hbx_id" => "1062521",
        ...
        "incomes" => [{
          ...
          "is_projected" => false,
          "employer" => {
            "employer_name" => "TreeLine", "employer_id" => nil
          },
        ...
        "benchmark_premium" => {
          "health_only_lcsp_premiums" => [{
            "member_identifier" => "1062521",
            "monthly_premium" => "829.3"
          }, {
            "member_identifier" => "1062533",
            "monthly_premium" => "923.55"
          }], "health_only_slcsp_premiums" => [{
            "member_identifier" => "1062521",
            "monthly_premium" => "835.01"
          }, {
            "member_identifier" => "1062533",
            "monthly_premium" => "929.92"
          }]
        },
        "is_homeless" => false,
        "mitc_income" => {
          "amount" => 50_000, "taxable_interest" => 0, "tax_exempt_interest" => 0, "taxable_refunds" => 0, "alimony" => 0, "capital_gain_or_loss" => 0, "pensions_and_annuities_taxable_amount" => 0, "farm_income_or_loss" => 0, "unemployment_compensation" => 0, "other_income" => 0, "magi_deductions" => 0, "adjusted_gross_income" => 50_000, "deductible_part_of_self_employment_tax" => 0, "ira_deduction" => 0, "student_loan_interest_deduction" => 0, "tution_and_fees" => 0, "other_magi_eligible_income" => 0
        },
        "mitc_relationships" => [{
          "other_id" => 1_062_533,
        ...
        "name" => {
          "first_name" => "Kar", "middle_name" => nil, "last_name" => "Test", "name_sfx" => nil, "name_pfx" => nil
        },
        "identifying_information" => {
          "encrypted_ssn" => "zJgfG+7d45lnwjJBUdG+c4EDv/8BKcFMnw==\n", "has_ssn" => false
        },
        "demographic" => {
          "gender" => "Female", "dob" => "1961-03-02", "ethnicity" => [], "race" => nil, "is_veteran_or_active_military" => false, "is_vets_spouse_or_child" => false
        },
        "attestation" => {
          "is_incarcerated" => false, "is_self_attested_disabled" => false, "is_self_attested_blind" => false, "is_self_attested_long_term_care" => false
        },
        ...
        "vlp_document" => nil,
        "family_member_reference" => {
          "family_member_hbx_id" => "1062533", "first_name" => "Kar", "last_name" => "Test", "person_hbx_id" => "1062533", "is_primary_family_member" => false
        },
        "person_hbx_id" => "1062533",
        "is_required_to_file_taxes" => true,
        "is_filing_as_head_of_household" => false,
        "tax_filer_kind" => "tax_filer",
        "is_joint_tax_filing" => true,
        ...
        "tax_household_members" => [{
          ...
          "applicant_reference" => {
            "first_name" => "Rich", "last_name" => "Test", "dob" => "1964-04-22", "person_hbx_id" => "1062521", "encrypted_ssn" => "5O82Dm9nfz7cpl/CwC3PJoEDvf4DI8FNlQ==\n"
          }
        }, {
          "product_eligibility_determination" => {
            "is_ia_eligible" => false, "is_medicaid_chip_eligible" => false, "is_totally_ineligible" => false, "is_magi_medicaid" => false, "is_non_magi_medicaid_eligible" => false, "is_without_assistance" => false, "magi_medicaid_monthly_household_income" => "0.0", "medicaid_household_size" => nil, "magi_medicaid_monthly_income_limit" => "0.0", "magi_as_percentage_of_fpl" => "0.0", "magi_medicaid_category" => nil
          ...
          "applicant_reference" => {
            "first_name" => "Kar", "last_name" => "Test", "dob" => "1961-03-02", "person_hbx_id" => "1062533", "encrypted_ssn" => "zJgfG+7d45lnwjJBUdG+c4EDv/8BKcFMnw==\n"
          }
        }],
      ...
      }], "us_state" => "ME", "hbx_id" => "1215981", "oe_start_on" => oe_start_on.to_s, "notice_options" => {
  ...
  let(:mitc_string_response) do
    {
      "Determination Date" => start_of_year.to_s, "Applicants" => [{
        "Person ID" => 1_062_521,
        "Medicaid Household" => {
          "People" => [1_062_521, 1_062_533], "MAGI" => 50_000, "MAGI as Percentage of FPL" => 287, "Size" => 2
        },
        "Medicaid Eligible" => "N",
        "CHIP Eligible" => "N",
