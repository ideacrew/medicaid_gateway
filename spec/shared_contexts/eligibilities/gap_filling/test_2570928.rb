...
RSpec.shared_context 'gap_filling test_2570928', :shared_context => :metadata do
  let(:app_params) do
    {
      "family_reference" => {
        "hbx_id" => "2055891"
      }, "assistance_year" => 2022, "aptc_effective_date" => "2022-12-01", "years_to_renew" => 2027,
      "renewal_consent_through_year" => 5, "is_ridp_verified" => true, "is_renewal_authorized" => true, "applicants" => [{
        "name" => {
          "first_name" => "Gap", "middle_name" => nil, "last_name" => "Fill", "name_sfx" => nil, "name_pfx" => nil
        },
        "identifying_information" => {
          "encrypted_ssn" => "xgOtoqsZia0rIqxf1EgMI4cEufkALshJlg==\n", "has_ssn" => false
        },
        "demographic" => {
        ...
        "family_member_reference" => {
          "family_member_hbx_id" => "2055890", "first_name" => "Gap", "last_name" => "Fill",
          "person_hbx_id" => "2055890", "is_primary_family_member" => true
        },
        "person_hbx_id" => "2055890",
        ...
        "pregnancy_information" => {
          "is_pregnant" => false, "is_enrolled_on_medicaid" => false, "is_post_partum_period" => false, "expected_children_count" => nil,
          "pregnancy_due_on" => nil, "pregnancy_end_on" => nil
        },
        ...
        "incomes" => [{
          ...
          "ssi_type" => nil,
          "submitted_at" => "2022-11-14T22:27:58.000+00:00"
        }],
        "benefits" => [],
        "deductions" => [],
        ...
        "is_homeless" => false,
        "mitc_income" => {
          "amount" => 36_000, "taxable_interest" => 0, "tax_exempt_interest" => 0, "taxable_refunds" => 0, "alimony" => 0,
          "capital_gain_or_loss" => 0, "pensions_and_annuities_taxable_amount" => 0, "farm_income_or_loss" => 0,
          "unemployment_compensation" => 0, "other_income" => 0, "magi_deductions" => 0, "adjusted_gross_income" => 12_032,
        ...
        "income_evidence" => {
          ...
          "received_at" => "2022-11-14T22:25:46.820+00:00",
          "is_satisfied" => true, "verification_outstanding" => false, "update_reason" => nil,
          "due_on" => nil, "external_service" => nil, "updated_by" => nil,
        ...
        "esi_evidence" => {
          "key" => "esi_mec", "title" => "ESI MEC", "aasm_state" => "attested", "description" => nil,
          "received_at" => "2022-11-14T22:25:46.490+00:00",
          "is_satisfied" => true, "verification_outstanding" => false, "update_reason" => nil,
          "due_on" => nil, "external_service" => nil, "updated_by" => nil,
          "verification_histories" => [{
            "action" => "application_determined",
            ...
            "result" => "attested",
            "source" => "FDSH",
            "source_transaction_id" => "6372c070520b5c000dbfcdc2",
            "code" => "HE000001",
        ...
        "non_esi_evidence" => {
          "key" => "non_esi_mec", "title" => "Non ESI MEC", "aasm_state" => "attested", "description" => nil,
          "received_at" => "2022-11-14T22:25:46.514+00:00",
          "is_satisfied" => true, "verification_outstanding" => false, "update_reason" => nil,
          "due_on" => nil, "external_service" => nil, "updated_by" => nil,
          "verification_histories" => [{
            "action" => "application_determined",
            ...
            "result" => "eligible",
            "source" => "FDSH MEDI",
            "source_transaction_id" => "6372c07e520b5c000dbfcdc6",
            "code" => "HE040008",
            "code_description" => nil,
            "raw_payload" => ''
          }, {
        ...
        "local_mec_evidence" => {
          "key" => "local_mec", "title" => "Local MEC", "aasm_state" => "pending",
          "description" => nil, "received_at" => "2022-11-14T22:25:46.471+00:00",
          "is_satisfied" => true, "verification_outstanding" => false, "update_reason" => nil,
          "due_on" => nil, "external_service" => nil, "updated_by" => nil,
          "verification_histories" => [{
            "action" => "application_determined",
        ...
        "tax_household_members" => [{
          ...
          "applicant_reference" => {
            "first_name" => "Gap", "last_name" => "Fill", "dob" => "1980-01-01",
            "person_hbx_id" => "2055890", "encrypted_ssn" => "xgOtoqsZia0rIqxf1EgMI4cEufkALshJlg==\n"
          }
        }],
      ...
      }], "relationships" => [], "us_state" => "ME", "hbx_id" => "2570928", "oe_start_on" => "2021-11-01", "notice_options" => {
        ...
        "dependents" => []
      }], "submitted_at" => "2022-11-14T22:28:58.676+00:00"
    }
  end
  ...
  let(:mitc_string_response) do
    {
      "Determination Date" => "2022-11-14",
      "Applicants" => [{
        "Person ID" => 2_055_890,
        "Medicaid Household" => {
          "People" => [2_055_890], "MAGI" => 36_000, "MAGI as Percentage of FPL" => 264, "Size" => 1
        },
        "Medicaid Eligible" => "N",
        "CHIP Eligible" => "N",
