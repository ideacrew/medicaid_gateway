...
RSpec.shared_context 'esi_affordability test_10103189', :shared_context => :metadata do
  ...
  let(:app_params) do
    {
      "family_reference" => { "hbx_id" => "10101841" }, "assistance_year" => assistance_year, "aptc_effective_date" => aptc_effective_date,
      "years_to_renew" => assistance_year + 5, "renewal_consent_through_year" => 5,
      "is_ridp_verified" => true, "is_renewal_authorized" => true,
      "applicants" => [{
        "name" => { "first_name" => "Primary", "middle_name" => nil, "last_name" => "GlitchTest", "name_sfx" => nil, "name_pfx" => nil },
        "identifying_information" => { "encrypted_ssn" => "7WP7FWSG7ECnWnBOYrDQl4cCvvgDIsJInw==\n", "has_ssn" => false },
        "demographic" => {
        ...
        "mitc_income" => {
          ...
          "farm_income_or_loss" => 0, "unemployment_compensation" => 0, "other_income" => 0, "magi_deductions" => 0,
          "adjusted_gross_income" => 30_000, "deductible_part_of_self_employment_tax" => 0, "ira_deduction" => 0,
        ...
        "income_evidence" => {
          ...
          "update_reason" => nil, "due_on" => nil, "external_service" => nil, "updated_by" => nil,
        ...
        "demographic" => {
          "gender" => "Female", "dob" => "1980-01-01", "ethnicity" => [],
          "race" => nil, "is_veteran_or_active_military" => false, "is_vets_spouse_or_child" => false
        },
        "attestation" => {
          "is_incarcerated" => false, "is_self_attested_disabled" => false, "is_self_attested_blind" => false,
        ...
        "mitc_income" => {
          ...
          "alimony" => 0, "capital_gain_or_loss" => 0, "pensions_and_annuities_taxable_amount" => 0,
          "farm_income_or_loss" => 0, "unemployment_compensation" => 0, "other_income" => 0, "magi_deductions" => 0,
          "adjusted_gross_income" => 20_000, "deductible_part_of_self_employment_tax" => 0, "ira_deduction" => 0,
          "student_loan_interest_deduction" => 0, "tution_and_fees" => 0, "other_magi_eligible_income" => 0
        },
        "mitc_relationships" => [{
          "other_id" => 10_101_840,
        ...
        "demographic" => {
          "gender" => "Female", "dob" => "2020-01-01", "ethnicity" => [],
          "race" => nil, "is_veteran_or_active_military" => false, "is_vets_spouse_or_child" => false
        },
        "attestation" => {
          "is_incarcerated" => false, "is_self_attested_disabled" => false, "is_self_attested_blind" => false,
        ...
        "mitc_income" => {
          ...
          "alimony" => 0, "capital_gain_or_loss" => 0, "pensions_and_annuities_taxable_amount" => 0,
          "farm_income_or_loss" => 0, "unemployment_compensation" => 0, "other_income" => 0, "magi_deductions" => 0,
          "adjusted_gross_income" => 0, "deductible_part_of_self_employment_tax" => 0, "ira_deduction" => 0,
          "student_loan_interest_deduction" => 0, "tution_and_fees" => 0, "other_magi_eligible_income" => 0
        },
        "mitc_relationships" => [{
          "other_id" => 10_101_840,
      ...
      }], "us_state" => "ME", "hbx_id" => "10103189", "oe_start_on" => oe_start_on, "notice_options" => {
  ...
  let(:mitc_string_response) do
    {
      ...
      Applicants: [
        ...
        },
        {
          ...
          "Other Outputs": {
            "Qualified Children List": [
              { "Person ID": 10_101_843,
                Determinations: {
                  "Dependent Age": { Indicator: "Y" },
                  "Deprived Child": { Indicator: "X" },
                  Relationship: { Indicator: "Y" }
                } }
            ]
          }
        },
        {
          "Person ID": 10_101_843,
          "Medicaid Household": {
            People: [10_101_840, 10_101_842, 10_101_843],
            MAGI: 50_000,
            "MAGI as Percentage of FPL": 217,
            Size: 3
          },
          ...
          Determinations: {
            ...
            "CHIP Targeted Low Income Child": { Indicator: "Y" },
