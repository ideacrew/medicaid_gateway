...
RSpec.shared_context 'esi_affordability test_10103190', :shared_context => :metadata do
  ...
  let(:app_params) do
    {
      "family_reference" => { "hbx_id" => "10101841" },
      "assistance_year" => assistance_year, "aptc_effective_date" => aptc_effective_date, "years_to_renew" => assistance_year + 5,
      "renewal_consent_through_year" => 5, "is_ridp_verified" => true, "is_renewal_authorized" => true, "applicants" => [{
        ...
        "income_evidence" => {
          ...
          "external_service" => nil, "updated_by" => nil, "verification_histories" => [{
        ...
        "non_esi_evidence" => {
          "key" => "non_esi_mec", "title" => "Non ESI MEC", "aasm_state" => "pending", "description" => nil, "received_at" => start_of_year.to_s,
          "is_satisfied" => true, "verification_outstanding" => false, "update_reason" => nil, "due_on" => nil,
          "external_service" => nil, "updated_by" => nil, "verification_histories" => [{
            "action" => "application_determined",
            "modifier" => nil,
      ...
      }], "us_state" => "ME", "hbx_id" => "10103190", "oe_start_on" => "2021-11-01", "notice_options" => {
