...
RSpec.shared_context 'esi_affordability test_10103188', :shared_context => :metadata do
  ...
  let(:app_params) do
    {
      ...
      "applicants" => [{
        ...
        "demographic" => {
          "gender" => "Male", "dob" => "1980-01-01", "ethnicity" => [], "race" => nil,
        ...
        "family_member_reference" => {
          "family_member_hbx_id" => "10101840", "first_name" => "Primary", "last_name" => "GlitchTest", "person_hbx_id" => "10101840",
        ...
        "is_homeless" => false,
        "mitc_income" => {
          "amount" => 30_000, "taxable_interest" => 0, "tax_exempt_interest" => 0,
          "taxable_refunds" => 0, "alimony" => 0, "capital_gain_or_loss" => 0,
          "pensions_and_annuities_taxable_amount" => 0, "farm_income_or_loss" => 0, "unemployment_compensation" => 0, "other_income" => 0,
          "magi_deductions" => 0, "adjusted_gross_income" => 30_000, "deductible_part_of_self_employment_tax" => 0, "ira_deduction" => 0,
        ...
        "income_evidence" => {
          "key" => "income", "title" => "Income", "aasm_state" => "pending", "description" => nil, "received_at" => start_of_year.to_s,
          "is_satisfied" => true, "verification_outstanding" => false, "update_reason" => nil, "due_on" => nil, "external_service" => nil,
          "updated_by" => nil,
        ...
        "esi_evidence" => {
          "key" => "esi_mec", "title" => "ESI MEC", "aasm_state" => "attested", "description" => nil, "received_at" => start_of_year.to_s,
          "is_satisfied" => true, "verification_outstanding" => false, "update_reason" => nil, "due_on" => nil, "external_service" => nil,
          "updated_by" => nil,
          "verification_histories" => [{
            "action" => "application_determined",
        ...
        "non_esi_evidence" => {
          "key" => "non_esi_mec", "title" => "Non ESI MEC", "aasm_state" => "attested", "description" => nil, "received_at" => start_of_year.to_s,
          "is_satisfied" => true, "verification_outstanding" => false, "update_reason" => nil, "due_on" => nil, "external_service" => nil,
          "updated_by" => nil,
          "verification_histories" => [{
            "action" => "application_determined",
        ...
        "local_mec_evidence" => {
          "key" => "local_mec", "title" => "Local MEC", "aasm_state" => "attested", "description" => nil, "received_at" => start_of_year.to_s,
          "is_satisfied" => true, "verification_outstanding" => false, "update_reason" => nil, "due_on" => nil, "external_service" => nil,
          "updated_by" => nil,
          "verification_histories" => [{
            "action" => "application_determined",
        ...
        "vlp_document" => nil,
        "family_member_reference" => {
          "family_member_hbx_id" => "10101842", "first_name" => "Spouse", "last_name" => "GlitchTest", "person_hbx_id" => "10101842",
        ...
        "is_homeless" => false,
        "mitc_income" => {
          "amount" => 20_000, "taxable_interest" => 0, "tax_exempt_interest" => 0,
          "taxable_refunds" => 0, "alimony" => 0, "capital_gain_or_loss" => 0,
          "pensions_and_annuities_taxable_amount" => 0, "farm_income_or_loss" => 0, "unemployment_compensation" => 0, "other_income" => 0,
          "magi_deductions" => 0, "adjusted_gross_income" => 20_000, "deductible_part_of_self_employment_tax" => 0, "ira_deduction" => 0,
          "student_loan_interest_deduction" => 0, "tution_and_fees" => 0, "other_magi_eligible_income" => 0
        },
        "mitc_relationships" => [{
          "other_id" => 10_101_840,
        ...
        "vlp_document" => nil,
        "family_member_reference" => {
          "family_member_hbx_id" => "10101843", "first_name" => "Child", "last_name" => "GlitchTest", "person_hbx_id" => "10101843",
          "is_primary_family_member" => false
        },
        ...
        "claimed_as_tax_dependent_by" => {
          "first_name" => "Primary", "last_name" => "GlitchTest", "dob" => "1980-01-01", "person_hbx_id" => "10101840",
          "encrypted_ssn" => "7WP7FWSG7ECnWnBOYrDQl4cCvvgDIsJInw==\n"
        },
        "student" => {
          "is_student" => false, "student_kind" => nil, "student_school_kind" => nil, "student_status_end_on" => nil
        ...
        "mitc_income" => {
          ...
          "taxable_refunds" => 0, "alimony" => 0, "capital_gain_or_loss" => 0,
          "pensions_and_annuities_taxable_amount" => 0, "farm_income_or_loss" => 0, "unemployment_compensation" => 0, "other_income" => 0,
          "magi_deductions" => 0, "adjusted_gross_income" => 0, "deductible_part_of_self_employment_tax" => 0, "ira_deduction" => 0,
          "student_loan_interest_deduction" => 0, "tution_and_fees" => 0, "other_magi_eligible_income" => 0
        },
        "mitc_relationships" => [{
          "other_id" => 10_101_840,
        ...
        "income_evidence" => {
          "key" => "income", "title" => "Income", "aasm_state" => "attested", "description" => nil, "received_at" => start_of_year.to_s,
          "is_satisfied" => true, "verification_outstanding" => false, "update_reason" => nil, "due_on" => nil, "external_service" => nil,
          "updated_by" => nil,
          "verification_histories" => [{
            "action" => "application_determined",
        ...
        "tax_household_members" => [{
          "product_eligibility_determination" => {
            ...
            "magi_medicaid_monthly_household_income" => "0.0", "medicaid_household_size" => nil, "magi_medicaid_monthly_income_limit" => "0.0",
          ...
          "applicant_reference" => {
            "first_name" => "Spouse", "last_name" => "GlitchTest", "dob" => "1980-01-01", "person_hbx_id" => "10101842",
            "encrypted_ssn" => "vY1xKMf8hcEgSkfLUqTbvYcCuPgBLsZPlw==\n"
          }
        }, {
          "product_eligibility_determination" => {
          ...
          "applicant_reference" => {
            "first_name" => "Child", "last_name" => "GlitchTest", "dob" => "2020-01-01", "person_hbx_id" => "10101843",
            "encrypted_ssn" => "zc+h9yPnO0r3d6H9+Y1WeocEufkCLcZOng==\n"
          }
        }],
      ...
      }], "us_state" => "ME", "hbx_id" => "10103188", "oe_start_on" => oe_start_on, "notice_options" => {
