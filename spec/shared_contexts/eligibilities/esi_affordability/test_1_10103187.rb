...
RSpec.shared_context 'esi_affordability test_1_10103187', :shared_context => :metadata do
  let(:app_params) do
    {
      "family_reference" => {
        "hbx_id" => "10101841"
      }, "assistance_year" => 2022, "aptc_effective_date" => "2022-11-01T00:00:00.000+00:00",
      "years_to_renew" => 2027, "renewal_consent_through_year" => 5, "is_ridp_verified" => true,
      "is_renewal_authorized" => true, "applicants" => [{
        "name" => {
        ...
        "foster_care" => {
          "is_former_foster_care" => false, "age_left_foster_care" => nil,
        ...
        "incomes" => [{
          ...
          "ssi_type" => nil,
          "submitted_at" => "2022-10-11T20:41:57.000+00:00"
        }],
        "benefits" => [{
          "name" => nil,
          ...
          "start_on" => "2022-04-01",
          "end_on" => nil,
          "submitted_at" => "2022-10-11T20:42:42.000+00:00",
          "hra_kind" => nil
        }],
        "deductions" => [],
        ...
        "foster_care" => {
          "is_former_foster_care" => false, "age_left_foster_care" => nil,
          "foster_care_us_state" => nil, "had_medicaid_during_foster_care" => false
        },
        "pregnancy_information" => {
          "is_pregnant" => false, "is_enrolled_on_medicaid" => false, "is_post_partum_period" => false,
          "expected_children_count" => nil, "pregnancy_due_on" => nil, "pregnancy_end_on" => nil
        ...
        "incomes" => [{
          ...
          "has_property_usage_rights" => nil,
          "ssi_type" => nil,
          "submitted_at" => "2022-10-11T20:43:18.000+00:00"
        }],
        "benefits" => [],
        "deductions" => [],
        "is_medicare_eligible" => false,
      ...
      }], "us_state" => "ME", "hbx_id" => "10103187", "oe_start_on" => "2021-11-01", "notice_options" => {
      ...
      }], "submitted_at" => "2022-10-11T20:44:33.883+00:00"
    }
  end
  ...
  let(:mitc_string_response) do
    {
      "Determination Date" => "2022-10-12",
      "Applicants" => [{
        "Person ID" => 10_101_840,
        "Medicaid Household" => {
          "People" => [10_101_840, 10_101_842, 10_101_843], "MAGI" => 50_000, "MAGI as Percentage of FPL" => 217, "Size" => 3
        },
        "Medicaid Eligible" => "N",
        "CHIP Eligible" => "N",
