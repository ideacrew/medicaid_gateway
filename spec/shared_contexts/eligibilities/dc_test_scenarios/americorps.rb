...
RSpec.shared_context 'dc_test_scenarios americorps', :shared_context => :metadata do
  ...
  let(:app_params) do
    { "family_reference" => {
      ...
      "applicants" => [
        {
          "name" => { "first_name" => "Oblique", "middle_name" => nil, "last_name" => "Seven Correct",
                      "name_sfx" => nil, "name_pfx" => nil },
          "identifying_information" => { "encrypted_ssn" => "zxeEbm9fPa1Uw6621pvq9YEAuvAHK8NKng==\\n", "has_ssn" => false },
          "demographic" => {
            "gender" => "Female",
            "dob" => "1972-01-01",
            "ethnicity" => ["", "", "", "", "", "", ""],
          ...
          "native_american_information" => { "indian_tribe_member" => false, "tribal_id" => nil },
          ...
          "vlp_document" => {
            ...
            "alien_number" => "832748532",
            "i94_number" => nil,
            "visa_number" => nil,
            "passport_number" => "382938",
            "sevis_id" => "9238493049",
            ...
            "expiration_date" => "2027-04-21T00:00:00.000+00:00",
            "issuing_country" => nil
          },
          "family_member_reference" => {
            "family_member_hbx_id" => "99",
            "first_name" => "Oblique",
            "last_name" => "Seven Correct",
            "person_hbx_id" => "99",
          ...
          "incomes" => [{
            ...
            "submitted_at" => "2022-03-13T21:07:14.000+00:00"
          }],
          "benefits" => [{
            "name" => nil,
            "kind" => "americorps_health_benefits",
            "status" => "is_eligible",
            ...
            "start_on" => "2019-01-01",
            "end_on" => nil,
            "submitted_at" => "2022-03-13T21:10:11.000+00:00",
            "hra_kind" => nil
          }],
          "deductions" => [],
          ...
          "benchmark_premium" => {
            "health_only_lcsp_premiums" => [{
              ...
              "monthly_premium" => "556.65"
            },
                                            { "member_identifier" => "100",
                                              "monthly_premium" => "254.4" }],
            "health_only_slcsp_premiums" => [{
              "member_identifier" => "99",
              "monthly_premium" => "563.76"
            },
                                             { "member_identifier" => "100",
          ...
          "mitc_relationships" => [{ "other_id" => 100, "attest_primary_responsibility" => "Y", "relationship_code" => "03" }],
        ...
        {
          "name" => { "first_name" => "Daughter", "middle_name" => nil, "last_name" => "Seven", "name_sfx" => nil, "name_pfx" => nil },
          "identifying_information" => { "encrypted_ssn" => "asvpjms4Pw1RwXxYZHaWA4MLsfoHK8NHlA==\\n", "has_ssn" => false },
          "demographic" => {
            "gender" => "Female",
            "dob" => "2004-01-01",
            "ethnicity" => [],
          ...
          "Seven Correct",
            "dob" => "1972-01-01",
            "person_hbx_id" => "99",
            "encrypted_ssn" => "zxeEbm9fPa1Uw6621pvq9YEAuvAHK8NKng==\\n"
          },
          "student" => { "is_student" => false, "student_kind" => nil, "student_school_kind" => nil, "student_status_end_on" => nil },
          "is_refugee" => false,
          "is_trafficking_victim" => false,
          ...
          "has_self_employment_income" => false,
          "has_unemployment_income" => false,
          "has_other_income" => false, "has_deductions" => false,
          "has_enrolled_health_coverage" => false,
          "has_eligible_health_coverage" => true,
          "job_coverage_ended_in_past_3_months" => false,
          "job_coverage_end_date" => nil,
          ...
          "incomes" => [{
            ...
            "has_property_usage_rights" => nil,
            "submitted_at" => "2022-03-13T21:12:08.000+00:00"
          }],
          "benefits" => [{
            "name" => nil,
            "kind" => "private_health_insurance_plan",
            "status" => "is_eligible",
            "is_employer_sponsored" => false,
            "employer" => nil,
            "esi_covered" => nil,
            ...
            "start_on" => "2019-01-01",
            "end_on" => nil,
            "submitted_at" => "2022-03-13T21:12:42.000+00:00",
            "hra_kind" => nil
          }],
          "deductions" => [],
          "is_medicare_eligible" => false,
          ...
          "is_claimed_as_dependent_by_non_applicant" => false,
          "benchmark_premium" => {
            "health_only_lcsp_premiums" => [{ "member_identifier" => "99", "monthly_premium" => "556.65" },
                                            { "member_identifier" => "100",
                                              "monthly_premium" => "254.4" }],
            "health_only_slcsp_premiums" => [
              { "member_identifier" => "99", "monthly_premium" => "563.76" },
              { "member_identifier" => "100", "monthly_premium" => "257.65" }
            ]
          },
          "is_homeless" => false,
          "mitc_income" => {
          ...
          "mitc_relationships" => [
            { "other_id" => 99, "attest_primary_responsibility" => "N", "relationship_code" => "04" }
          ],
          "mitc_is_required_to_file_taxes" => true,
          "income_evidence" => nil,
          "esi_evidence" => nil,
      ...
      "tax_households" => [
        {
          ...
          "tax_household_members" => [{
            ...
            "applicant_reference" => { "first_name" => "Oblique", "last_name" => "Seven Correct", "dob" => "1972-01-01", "person_hbx_id" => "99",
                                       "encrypted_ssn" => "zxeEbm9fPa1Uw6621pvq9YEAuvAHK8NKng==\\n" }
          },
                                      {
                                        "product_eligibility_determination" => {
                                        ...
                                        "applicant_reference" => {
                                          ...
                                          "dob" => "2004-01-01",
                                          "person_hbx_id" => "100",
                                          "encrypted_ssn" => "asvpjms4Pw1RwXxYZHaWA4MLsfoHK8NHlA==\\n"
                                        }
                                      }],
      ...
      "relationships" => [{
        "kind" => "child",
        "applicant_reference" => { "first_name" => "Daughter", "last_name" => "Seven", "dob" => "2004-01-01", "person_hbx_id" => "100",
                                   "encrypted_ssn" => "asvpjms4Pw1RwXxYZHaWA4MLsfoHK8NHlA==\\n" },
        "relative_reference" => { "first_name" => "Oblique", "last_name" => "Seven Correct", "dob" => "1972-01-01", "person_hbx_id" => "99",
                                  "encrypted_ssn" => "zxeEbm9fPa1Uw6621pvq9YEAuvAHK8NKng==\\n" }
      },
                          { "kind" => "parent",
                            "applicant_reference" => {
      ...
      "notice_options" => { "send_eligibility_notices" => true, "send_open_enrollment_notices" => false, "paper_notification" => true },
      "mitc_households" => [{
        "household_id" => "1",
        "people" => [{ "person_id" => 99 }, { "person_id" => 100 }]
      }],
      "mitc_tax_returns" => [{ "filers" => [{ "person_id" => 99 }], "dependents" => [{ "person_id" => 100 }] }],
      "submitted_at" => "2022-03-13T21:13:34.669+00:00",
  ...
  let(:mitc_string_response) do
    { "Determination Date" => "2022-04-13",
      "Applicants" => [
        { "Person ID" => 99,
          "Medicaid Household" => {
            "People" => [99, 100],
            "MAGI" => 80_000,
            "MAGI as Percentage of FPL" => 459,
            "Size" => 2
          },
          "Medicaid Eligible" => "N",
          "CHIP Eligible" => "N",
