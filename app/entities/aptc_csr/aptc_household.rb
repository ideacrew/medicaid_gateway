...
module AptcCsr
  ...
  class AptcHousehold < Dry::Struct
    ...
    attribute :total_expected_contribution_amount, Types::Money
    attribute :total_benchmark_plan_monthly_premium_amount, Types::Money
    attribute :csr_percentage, Types::Integer.optional.meta(omittable: true)
