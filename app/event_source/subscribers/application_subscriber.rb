...
module EventSource
  module Subscribers
    ...
    class ApplicationSubscriber
      ...
      # include ::EventSource::Subscriber[amqp: 'on_medicaid_gateway.enroll.iap.applications']
      ...
      # subscribe(:"on_medicaid_gateway.enroll.iap.applications") do |_headers, payload|
